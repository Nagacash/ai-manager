...
export default function PremiumButton({
    ...
    const variantStyles = {
        ...
        secondary:
            "bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 hover:border-purple-500/50 shadow-premium-sm hover:shadow-premium-md",
        outline:
            "bg-transparent border-2 border-slate-700 hover:border-purple-500 text-slate-300 hover:text-white hover:bg-purple-500/10",
    };
