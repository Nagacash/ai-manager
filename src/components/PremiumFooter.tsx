...
export default function PremiumFooter({ navLinks }: FooterProps) {
    return (
        <footer className="relative bg-gradient-to-b from-background to-black/40 border-t border-white/10 overflow-hidden">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
                            <Button
                                variant="outline"
                                size="icon"
                                className="rounded-full size-11 border-white/20 bg-white/5 hover:bg-gradient-to-br hover:from-purple-500/20 hover:to-cyan-500/20 hover:border-purple-500/40 text-slate-300 hover:text-white transition-all backdrop-blur-sm"
