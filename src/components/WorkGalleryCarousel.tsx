    ...
    <div className="w-full space-y-4">
      {projects.map((project: any, index: number) => (
        <motion.a
          ...
          className="group flex items-center justify-between gap-6 p-6 md:p-8 rounded-2xl border border-slate-800 bg-slate-900/30 hover:bg-white/5 hover:border-white/30 transition-all duration-300 cursor-pointer"
        >
          ...
          <div className="flex-shrink-0 size-10 rounded-full border border-slate-700 flex items-center justify-center group-hover:border-white/40 group-hover:bg-white/10 transition-all">
            <ArrowUpRight className="size-4 text-slate-500 group-hover:text-white group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
          </div>
        </motion.a>
      ))}
    </div>
